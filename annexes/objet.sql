...
--
-- Hôte : localhost:3306
-- Généré le : lun. 22 nov. 2021 à 00:34
...
('carotte', 48.805, 2.11988, 15, 'images/carotte.png', 1, 0, 0, 1, '48.7621$2.04996', 'Je suis une carotte', 80, 100, NULL, NULL),
('myrtille', 49.031, 5.98465, 15, 'images/myrtille.png', 2, 0, 0, 1, '\r\n49.012$6.23956', 'Je suis le dessert d\'Ilone', 95, 60, NULL, NULL),
...
('BAL', 48.8514, 2.37586, 1, 'images/bal.jpeg', 16, 0, 1, 0, NULL, 'Oh non, vous nous réveillez!$Mmmh quelle bonne banane! Merci, on peut y aller! Ilona n\'est pas avec vous ? Il faut aller au Sud de Metz pour la trouver !\r\n', 75, 79, 'O', '26'),
('RIVIERE', 48.8509, 2.37775, 1, 'images/riviere.jpg', 15, 0, 1, 0, NULL, '\r\nOula ! Doucement ! Nous n\'avons pas petit-déjeuné, pouvez-vous me ramener une carotte (#BDEdeMERDE) et une banane pour mon collègue?. Il y a un champ de carotte/banane non loin de la Bastille.$Mmmh trop bon, merci l\'ami! En route, vers l\'Est chez Ilona!', 56, 100, 'O', '25'),
...
('BARAN', 49.012, 6.23956, 1, 'images/baran.jpg', 17, 0, 1, 0, NULL, 'Olala je suis grave en retard, attendez je mange ma purée de carotte et on y va! Mince, il me manque une mirabelle pour le dessert, il y en a dans la forêt juste à côté!$Ouf, on peut partir maintenant qu\'on a le ventre plein!\r\n', 56, 100, 'O', '2'),
('PAPADUTREMBLE', 46.725, 4.48894, 1, 'images/papaDutremble.jpg', 18, NULL, 0, NULL, NULL, 'Vous le ratez de peu, il vient de partir pour Oslo!\r\n', 70, 45, NULL, NULL),
('DUTREMBLE', 59.954, 10.7314, 1, 'images/dutremble.jpg', 19, 0, 1, 0, NULL, '\r\nOh mais que faites-vous ici? Je pars avec vous si vous devinez ce qu\'est un brunost ?$Bravo, c\'est un fromage norvégien à pâte brune et au goût caramélisé.', 60, 120, 'C', 'fromage'),
('BLAREL', 50.7459, 2.16434, 1, 'images/blarel.jpg', 20, NULL, 1, NULL, NULL, 'Salut! Oh trop cool ce mign\'ibus! Allez je pars avec vous!$Oh non! CATASTROPHE, j\'ai perdu mon masque, pouvez-vous m\'aider (#COVIDONRESPECTE).\r\n', 70, 92, 'O', '28'),
...
('cle', 45.7775, 4.85512, 12, 'images/cle.png', 24, 0, 0, 1, '\r\n45.7682$4.85477', '\r\nDouble-click moi dessus et je rentrerai dans le trousseau.\r\n', 60, 55, NULL, NULL),
('carotteB', 48.8567, 2.37736, 17, 'images/carotte.png', 25, 0, 0, 1, '48.8509$2.37775', 'Je suis la carotte de Baptiste', 80, 100, NULL, NULL),
('bananeF', 48.8566, 2.38224, 17, 'images/banane.png', 26, 0, 0, 1, '48.8513$2.37585', 'Je suis une banane', 95, 65, NULL, NULL),
('BLAREL2', 50.7459, 2.16434, 10, 'images/blarelMasque.png', 27, 0, 1, 0, NULL, 'Oh merci beaucoup, ça y est je suis paré à vous suivre! Partons vite, notre cassis nous attend!', 70, 92, NULL, NULL),
('masque', 48.8644, 2.34416, 10, 'images/masque.png', 28, 0, 0, 1, '50.7459$2.16434', 'Je suis le masque de Maeve', 120, 95, NULL, NULL),
('LOSCO', 48.4471, -1.99119, 10, 'images/losco.jpg', 29, 0, 1, NULL, NULL, '\r\nYo la mif, t\'aurais pas vu mon kader (je crois que je l\'ai forget à l\'intramuros de Saint-Malo)?$Oh tu gères la fougère, je pars avec vous, ambiance à balle dans le bus! Direction corsica, Stella Maria nous attend.', 79, 109, 'O', '31'),
('kader', 48.6492, -2.02623, 15, 'images/kader.png', 31, 0, 0, 1, '\r\n48.4471$-1.99119', 'Je suis le kader d\'Axel', 60, 90, NULL, NULL),
('STEFANINI', 42.3069, 9.29097, 10, 'images/stefanini.png', 30, NULL, 1, NULL, NULL, '\r\n\r\nOh l\'ENSG en Corse, bienvenu! Je vous rejoins si vous devinez cette phrase corse: \"A sera lione, a mane cuglione\".$Oui, le soir lion, la matin couillon, ça part! Partons vite, Victor nous attend!  ', 70, 92, 'C', 'l'),
('COINDET2', 48.8414, 2.5883, 17, 'images/coindet.jpg', 32, NULL, NULL, NULL, NULL, 'Wouah, bravo! Merci à vous d\'être venu à ce super cours de WEB! Oh, mais il manque quelqu\'un!$Youpi, on va commencer le WEB! Alors, parlons projet... ça va fetcher sa mère! Vous avez 1 mois, fini la fête, bonjour les prises de tête!\r\n', 80, 80, NULL, NULL),
('AHR', 48.8417, 2.58882, 10, 'images/ahr.jpg', 33, NULL, NULL, NULL, NULL, 'Bah moi! Je suis là les amies.s, on peut commencer!', 70, 92, NULL, NULL),
('BUS', 48.8417, 2.58766, 10, 'images/bus/bus1_14.png', 34, NULL, NULL, NULL, NULL, 'Bah qui?$Ahahah', 245, 65, NULL, NULL),
('Coco', 48.8412, 2.58739, 10, 'images/coco.png', 304, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('Momo', 48.8412, 2.58739, 10, 'images/momo.png', 305, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('Nono', 48.8412, 2.58739, 10, 'images/nono.png', 306, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('Autre', 48.8412, 2.58739, 10, 'images/autre.png', 307, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
